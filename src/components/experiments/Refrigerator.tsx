...
const parts = [
  {
    name: '压缩机',
    state: '低压蒸气 → 高压高温蒸气',
    text: '外界提供电能，压缩机对蒸气做功。压力上升，温度也上升，制冷剂才能把热交给较冷的室内空气。',
    color: '#d9775d',
  },
  {
    name: '冷凝器',
    state: '高压蒸气 → 高压液体',
    text: '制冷剂在冰箱背后的管路中向房间放热，并逐渐冷凝成液体。所以冰箱背面会热。',
    color: '#dc9f52',
  },
  {
    name: '节流装置',
    state: '高压液体 → 低压液汽混合物',
    text: '制冷剂经过狭窄通道，压力骤降，部分液体闪蒸。理想节流过程近似等焓，而不是“冷气被挤出来”。',
    color: '#698bc1',
  },
  {
    name: '蒸发器',
    state: '低压液汽混合物 → 低压蒸气',
    text: '低压制冷剂在箱内管路中沸腾，从食物与空气吸热。随后蒸气回到压缩机，循环继续。',
    color: '#3599b5',
  },
];
export default function Refrigerator() {
  ...
  return (
    <div ref={host}>
      ...
      <div className="component-picks" role="group" aria-label="循环部件">
        {parts.map((p, i) => (
          <button
      ...
      <div className="lab-grid">
        <div className="lab-scene">
          ...
          <span className="refrigerator-cold">箱内 · 吸热</span>
          <span className="refrigerator-hot">室内 · 放热</span>
        ...
        <div className="lab-controls">
          ...
          <Range label="输入电功率" value={power} min={30} max={150} unit="W" onChange={setPower} />
          <Range
            label="假设制冷系数 COP"
            value={cop}
            min={1}
            ...
            step={0.1}
            onChange={setCop}
            help="每消耗 1 份电能，搬走几份热量。"
          />
        </div>
      </div>
      <div className="metrics">
        <Metric label="从箱内搬出的热流" value={(power * cop).toFixed(0)} unit="W" />
        <Metric label="输入电功率" value={power} unit="W" />
        <Metric label="向房间释放的热流" value={(power * (cop + 1)).toFixed(0)} unit="W" />
      </div>
      <p className="lab-caption">
        <strong>能量账本：</strong>向房间放出的热 = 从箱内吸走的热 + 输入电功。COP
        是自行设定的教学参数，数值不预测某台冰箱的真实性能；流动动画不代表分子的实际速度。
      </p>
    </div>
  );
}
